        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('libraries.update', $edit->id) }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="row p-t-20">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="firstName" class="form-control" placeholder="" name="judul" value="{{ $edit->judul }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-danger">
                                        <label class="control-label">Karya</label>
                                                <input type="text" id="lastName" class="form-control form-control-danger" placeholder="" name="karya" value="{{ $edit->karya }}">
                                            <small class="form-control-feedback"> Nama Pengarang. </small> </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group has-danger">
                                        <label class="control-label">Penerbit</label>
                                        <input type="text" id="lastName" class="form-control form-control-danger" placeholder="" name="penerbit" value="{{ $edit->penerbit }}">
