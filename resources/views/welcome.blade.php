                ...
                <div class="carousel-caption justify-content-center">
                  <div class="col-10 align-center">
                    ...
                    <div class="mbr-section-btn" buttons="0">
                      @auth
                      <a class="btn  display-4 btn-primary" href="{{ url('/member') }}">HOME</a>
                      @else
                      <a class="btn  display-4 btn-primary" href="{{ route('login') }}">MASUK</a>
                      @if (Route::has('register'))
                      <a class="btn  display-4 btn-white-outline" href="{{ route('register') }}">DAFTAR</a>
                      @endif
                    @endauth
                    </div>
                  </div>
              ...
              <div class="image_wrapper">
                ...
                <div class="carousel-caption justify-content-center">
                  <div class="col-10 align-left">
                    ...
                    <div class="mbr-section-btn" buttons="0">
                      @auth
                      <a class="btn  display-4 btn-danger" href="{{ url('/admin') }}">HOME</a>
                      @else
                      <a class="btn  display-4 btn-danger" href="{{ route('login') }}">MASUK</a>
                      @if (Route::has('register'))
                      <a class="btn  btn-white-outline display-4" href="{{ route('register') }}">DAFTAR</a>
                      @endif
                    @endauth
                    </div>
                  </div>
              ...
              <div class="image_wrapper">
                ...
                <div class="carousel-caption justify-content-center">
                  <div class="col-10 align-right">
                    ...
                    <div class="mbr-section-btn" buttons="0">
                      @auth
                      <a class="btn btn-info display-4" href="{{ url('/admin') }}">HOME</a>
                      @else
                      <a class="btn btn-info display-4" href="{{ route('login') }}">MASUK</a>
                      @if (Route::has('register'))
                      <a class="btn  btn-white-outline display-4" href="{{ route('register') }}">DAFTAR</a>
                      @endif
                    @endauth
